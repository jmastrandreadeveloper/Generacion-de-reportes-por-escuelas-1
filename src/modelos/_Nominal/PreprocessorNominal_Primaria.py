...
def process(dataframe: pd.DataFrame ):
    ...
    dataframe_1 = conservar_filas(dataframe , 'CURSO_NORMALIZADO',['7°'])# , '2°' , '3°' , '4°' , '5°' , '6°' , '7°'])
    # RENOMBRAR COLUMNAS
    ...
    df_nominal_processed = reordenar_columnas(
        dataframe_4,
        ['ciclo_lectivo','Alumno_ID','Alumno_división','DNI','Apellido','Nombre','Sexo','Fecha_Nacimiento',"Edad",'Edad_Correcta','Curso ','Curso','División','Turno','Modalidad','Nivel','Nivel_Unificado','Gestión','Supervisión','Escuela_ID','CUE','subcue','Número','Anexo','Número_Anexo','Escuela','Departamento','Localidad','zona','AMBITO','Regional',
    ...
    u.guardar_dataframe_a_csv(df_nominal_processed,'/data/processed/transformed/Nominal/' + dataFrame_name + '_df_nominal_processed.csv')    
    # se implementan las funciones para el preproceso del dataframe
    # quitar columnas para deja solamente las que me inteesan
    df_nominal_datos_institucionales = quitar_columnas(df_nominal_processed , ['Alumno_división', 'DNI' , 'Apellido', 'Nombre' ,'Fecha_Nacimiento', 'ciclo_lectivo','Alumno_ID','Sexo','Edad','Edad_Correcta','Curso ','Curso','División','Turno','Modalidad'] , True)        
    ...
    u.guardar_dataframe_a_csv(df_nominal_datos_institucionales,'/data/processed/transformed/Nominal/' + dataFrame_name + '_df_nominal_datos_institucionales.csv')
    u.guardar_dataframe_a_csv(_df_nominal_datos_institucionales_Escuela_ID,'/data/processed/transformed/Nominal/' + dataFrame_name + '_datos_institucionales_Escuela_ID.csv')
    u.guardar_dataframe_a_csv(_df_nominal_datos_institucionales_Lista_de_Supervisiones ,'/data/processed/transformed/Nominal/' + dataFrame_name + '_datos_institucionales_Lista_de_Supervisiones.csv')
