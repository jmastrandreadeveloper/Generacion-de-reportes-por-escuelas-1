...
def filtrar_dataframe_nominales_de_alumnos_por_escuela(df, Escuela_ID, show_index=True, columns=None, orientacion='records', condiciones=None):
    """
    ...
    try:
        ...
        if (Escuela_ID not in df['Escuela_ID'].unique()):
        ...
        dFrame_filtrado = df[(df['Escuela_ID'] == Escuela_ID)]
